...
export class CryptoAPI {
    ...
    async getPriceData(coinOption, curOption) {
        try {
            ...
            if(currentKey === process.env.API_KEY || currentKey === 'a63dd830-19c7-4468-8384-362be11a970a'){
                const res = await axios.get(`${this.baseUrl || 'https://min-api.cryptocompare.com/data/pricemulti'}?fsyms=${coinOption}&tsyms=${curOption}`);
